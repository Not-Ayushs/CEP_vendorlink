...
class DriverVendorDetailScreen extends StatefulWidget {
  ...
  @override
  State<DriverVendorDetailScreen> createState() =>
      _DriverVendorDetailScreenState();
}
...
class _DriverVendorDetailScreenState extends State<DriverVendorDetailScreen> {
  ...
  void initState() {
    super.initState();
    _qrScanned =
        widget.record['qr_verified'] == true ||
        widget.record['qrScanned'] == true;
    _photoAdded = widget.record['photoAdded'] == true;
  }
    ...
    final ok = await Navigator.push<bool>(
      ...
      MaterialPageRoute(
        builder: (_) => QrScannerScreen(
          expectedVendorId: widget.record['vendorId'],
          expectedRecordId: widget.record['id'],
          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  Text(
                    'Declared: ${widget.record['declaredWaste']} kg',
                  ...
                  if ((widget.record['declaredWaste'] as num).toDouble() !=
                      weight)
                    Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              _buildAction(
                ...
                'Scan Vendor QR',
                _qrScanned ? 'Server verified' : 'Scan and verify location',
                _qrScanned,
                _qrScanned ? null : () => _scanServerQr(),
              ),
              const SizedBox(height: 12),
              _buildAction(
                Icons.camera_alt,
              ...
              ElevatedButton(
                onPressed: (canCollect && !_submitting)
                    ? _confirmAndCollect
                    : null,
                style: ElevatedButton.styleFrom(
                  backgroundColor: AppTheme.primary,
              ...
              if (!canCollect)
                const Padding(
                  ...
                  child: Text(
                    'Complete server QR verification and photo first',
        ...
        child: Row(
          children: [
            Container(
              padding: const EdgeInsets.all(12),
              decoration: BoxDecoration(
                color: done ? Colors.green[50] : Colors.grey[100],
                shape: BoxShape.circle,
              ),
              child: Icon(
                icon,
                color: done ? Colors.green[600] : Colors.grey[600],
              ),
            ),
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    subtitle,
                    style: TextStyle(
                      color: done ? Colors.green[700] : Colors.black54,
                    ),
                  ),
                ],
              ),

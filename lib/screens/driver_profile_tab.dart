            ...
            children: [
              ...
              Center(
                child: CircleAvatar(
                  ...
                  child: const Icon(Icons.local_shipping, size: 44, color: Colors.black54),
                ),
              ),
              const SizedBox(height: 16),
              Center(
                child: Text(user?.email ?? 'Driver',
                    style: const TextStyle(fontSize: 17, fontWeight: FontWeight.bold)),
              ),
              const Center(
                child: Padding(
                  padding: EdgeInsets.only(top: 4),
                  child: Text('Driver Account', style: TextStyle(color: Colors.black45, fontSize: 13)),
                ),
              ),
